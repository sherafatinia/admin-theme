								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link active" href="/admin">
                                            ...
                                            <span class="menu-title">Dragables</span>
                                        </a>
                                    </div>

                                    <div class="menu-item">
                                        <a class="menu-link active" href="/jquery">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">JQuery
									<!--begin::Separator-->
							...
							<div id="kt_content_container" class="container-xxl">
                                ...
                                <div class="py-10">
                                    ...
                                    <h1 class="anchor fw-bolder mb-5" id="zero-configuration">
                                        <a href="#zero-configuration"></a>JQuery</h1>
                                    <!--end::Heading-->
                                    <!--begin::Block-->
